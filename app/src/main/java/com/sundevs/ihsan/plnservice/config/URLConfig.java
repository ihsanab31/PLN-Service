...
public class URLConfig {
    public static final String REGISTER_URL = "http://belajarwelah.hol.es/register.php";
    public static final String LOGIN_URL = "http://belajarwelah.hol.es/login.php";
    public static final String BERITA_URL = "http://belajarwelah.hol.es/berita.php?offset=";
